	...
	override function create() {
		...
		if (WeekData.weeksList.length < 1) {
			...
			FlxG.switchState(new states.ErrorState("NO WEEKS ADDED FOR FREEPLAY\n\nPress ACCEPT to go to the Week Editor Menu.\nPress BACK to return to Main Menu.",
				function() FlxG.switchState(new states.editors.WeekEditorState()), function() FlxG.switchState(new states.MainMenuState())));
			return;
		}
		...
		var leText:String = Language.getPhrase("freeplay_tip",
			"Press SPACE to listen to the Song / Press " + Main.modifier_keys[0] +
			" to open the Gameplay Changers Menu / Press RESET to Reset your Score and Accuracy.");
		bottomString = leText;
		var size:Int = 16;
